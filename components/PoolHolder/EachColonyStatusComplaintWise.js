...
const EachColonyStatusComplaintWise = ({ navigation, route }) => {
  ...
  const FeedbackBox = (props) => {
    return (
      <View>
        <TouchableOpacity
          onPress={() => {
            navigation.navigate("ComplaintDetailedBox", {
              name: props.name,
        ...
        >
          ...
          >
            ...
            >
              <View>
                <Text style={{ fontSize: 15, color: "white" }}>Status : </Text>
              </View>
              <View>
                <Text style={{ fontSize: 15, color: "white" }}>
                  {props.status}
  ...
  return (
    <View>
      <Redbox content={colony + " COMPLAINT"}></Redbox>
        ...
        data.map((item) => {
          return (
            <FeedbackBox
              ...
              rating="4.7"
              complaint="Leakage in rooms, Broken Windows and Water Logging"
              status={item.status}
              date={item.date}
              id={item.id}
            ></FeedbackBox>
...
export default EachColonyStatusComplaintWise;
