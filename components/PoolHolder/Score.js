      ...
      <TouchableOpacity
        onPress={() => {
          if (props.check == "Score")
            props.navigation.navigate("PoolScore", {
              id: props.id,
              token: props.token,
              data: props.data,
              name: props.name,
          ...
          if (props.check == "Complaint")
            props.navigation.navigate("PoolComplaint", {
              id: props.id,
              token: props.token,
              data: props.data,
              name: props.name,
          ...
          if (props.check == "Feedback")
            props.navigation.navigate("PoolFeedback", {
              id: props.id,
              token: props.token,
              data: props.data,
              name: props.name,
          ...
          if (props.check == "Occupancy")
            props.navigation.navigate("PoolOccupancy", {
              id: props.id,
              token: props.token,
              data: props.data,
              name: props.name,
